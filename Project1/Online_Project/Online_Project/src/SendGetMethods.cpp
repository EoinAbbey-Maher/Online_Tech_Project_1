...
bool GameClient::recvall(char * data, int totalBytes)
{
...
bool GameClient::sendall(const char * data, const int totalBytes)
{
...
bool GameClient::Getint32_t(std::int32_t & int32_t)
{
...
bool GameClient::GetPacketType(PacketType & packetType)
{
...
void GameClient::SendString(const std::string & str)
{
	PS::ChatMessage cm(str);
	m_pm.Append(cm.toPacket());
}

bool GameClient::GetString(std::string & str)
{
